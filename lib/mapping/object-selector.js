  ...
  static getForSelect(
    ...
    return Promise.all(
      ...
      for (let i = 0; i < tables.length; i++) {
        ...
        // if (!allowFilter && !allPropertiesArePrimaryKeys) {
        //   continue;
        // }
        // }
      ...
      //   let message = `No table matches the filter (${
      //     allPKsDefined ? "all PKs have to be specified" : "PKs"
